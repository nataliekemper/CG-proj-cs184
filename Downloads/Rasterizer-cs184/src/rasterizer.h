...
namespace CGL {
  ...
  public:
    ...
    virtual double lineEquation(float x0, float y0,
                              float x1, float y1,
                              float px, float py) = 0;
  ...
  public:
    ...
    double lineEquation(float x0, float y0,
                      float x1, float y1,
                      float px, float py);
    ...
    Vector2D barycentric(float x0, float y0, float x1, float y1, float x2, float y2,
